execute store result score @s custom_damage_invisi_gun run data get entity @s SelectedItem.tag.CustomDamage 1
...
execute store result score @s custom_damage_invisi_gun run data get entity @s SelectedItem.tag.Damage -1
