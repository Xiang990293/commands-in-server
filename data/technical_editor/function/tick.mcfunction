...
#修改物品展示實體
execute as @e[type=villager,tag=modify_item_display] at @s run data modify entity @s item set from entity @p Inventory[{Slot:-106b}]
kill @e[type=villager,tag=modify_item_display]

#新增文字展示實體
execute as @e[type=villager,tag=spawn_text_display] at @s summon text_display run data modify entity @s text set from entity @n CustomName
kill @e[type=villager,tag=spawn_text_display]
#刪除文字展示實體
execute as @e[type=villager,tag=kill_text_display] at @s run kill @n[type=text_display,distance=..3]
kill @e[type=villager,tag=kill_text_display]
...
#新增標籤-展示實體與標籤
execute as @e[type=villager,tag=add_tag_technical] at @s run data modify entity @n[type=#technical_editor:technical_entities,distance=..3] Tags append string entity @s CustomName 1 -1
...
#新增標籤-所有實體
execute as @e[type=villager,tag=add_tag_general] at @s run data modify entity @n[distance=..3] Tags append string entity @s CustomName 1 -1
