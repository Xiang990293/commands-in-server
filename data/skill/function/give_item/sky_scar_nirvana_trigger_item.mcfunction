...
##給物品法(兩者可通用，但下者較簡單)
execute as sky_scar at @s run give @s slime_ball[lore=['{"italic":false,"text":"使用後會在除了你以外最近的5位玩家，會在其位置召喚一隻高壓苦力怕"}'],item_name='{"italic":false,"color":"blue","text":"雷神"}',enchantments={levels:{infinity:1,mending:1}}] 1